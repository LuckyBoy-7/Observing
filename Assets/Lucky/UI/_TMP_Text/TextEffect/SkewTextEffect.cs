...
namespace Lucky.UI._TMP_Text.TextEffect
{
    ...
    public class SkewTextEffect : MonoBehaviour
    {
        ...
        IEnumerator WarpText()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // 这个是baseline的位置
                    // 原理就是先把字符整体偏移到baseline的位置（或者说我们后续要对以baseline为基准，对字符四个方向向量做变换）
                    // 然后变换好了再偏移回去
                    ...
                    // 获取两个向量的夹角[0, 360]，虽然好像不用叉积判断直接比比大小就行了
