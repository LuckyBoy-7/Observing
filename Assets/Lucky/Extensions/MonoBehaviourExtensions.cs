...
namespace Lucky.Extensions
{
    public static class ManagedBehaviourExtensions
    {
        ...
        )
        {
            ...
            orig.Add(new Coroutine(Tick(), removeOnComplete: true));
        ...
        public static T NewSonWithComponent<T>(this ManagedBehaviour orig) where T : MonoBehaviour
        {
        ...
        public static T NewUISonWithComponent<T>(this ManagedBehaviour orig) where T : MonoBehaviour
        {
        ...
        public static T NewUIRootWithComponent<T>(this ManagedBehaviour orig) where T : MonoBehaviour
        {
        ...
        public static T NewUIBrotherWithComponent<T>(this ManagedBehaviour orig) where T : MonoBehaviour
        {
            T component = new GameObject(typeof(T).Name).AddComponent<RectTransform>().gameObject.AddComponent<T>();
        ...
        /// </summary>
        public static T LoadAndInstantiate<T>(this ManagedBehaviour orig, string path, bool isChild) where T : MonoBehaviour
        {
